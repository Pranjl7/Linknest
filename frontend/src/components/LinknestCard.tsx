...
const colorStyles: Record<TagColor, string> = {
  ...
  purple: "text-purple-600 dark:text-[#9f7aea] border-purple-200 dark:border-[#9f7aea]/30 bg-purple-50 dark:bg-[#9f7aea]/10",
  orange: "text-orange-600 dark:text-[#ed8936] border-orange-200 dark:border-[#ed8936]/30 bg-orange-50 dark:bg-[#ed8936]/10",
  blue: "text-blue-600 dark:text-[#63b3ed] border-blue-200 dark:border-[#63b3ed]/30 bg-blue-50 dark:bg-[#63b3ed]/10",
  green: "text-green-600 dark:text-[#48bb78] border-green-200 dark:border-[#48bb78]/30 bg-green-50 dark:bg-[#48bb78]/10",
};
    ...
    <div className="flex flex-col p-5 rounded-2xl bg-white dark:bg-[#111214] border border-gray-200 dark:border-[#2d2d33] hover:border-gray-300 dark:hover:border-[#4d4d55] transition-colors duration-300 w-full relative group shadow-sm hover:shadow-lg dark:shadow-none">
      ...
      <div className="flex justify-between items-start mb-4">
        <div className="flex items-center gap-2 px-2.5 py-1 rounded-full border border-green-200 dark:border-[#1c4028] bg-green-50 dark:bg-[#0c2415] transition-colors duration-300">
          ...
          <span className="text-[11px] font-medium text-green-700 dark:text-[#34d399]">{status}</span>
        </div>
      </div>
      ...
      <p className="text-xs text-gray-500 dark:text-gray-400 mb-6 transition-colors duration-300">
        Posted by <span className="text-gray-700 dark:text-gray-300 font-medium transition-colors duration-300">{author}</span>
      </p>
      ...
      <div className="mb-5 flex items-center gap-2 overflow-hidden">
        ...
        <a href={url} target="_blank" rel="noreferrer" className="text-[12px] font-medium text-gray-600 dark:text-gray-400 hover:text-blue-500 dark:hover:text-blue-400 hover:underline truncate transition-colors duration-300">
      ...
      <div className="mt-auto">
        <div className="h-[1px] w-full bg-gray-100 dark:bg-[#2d2d33] mb-4 transition-colors duration-300"></div>
        <div className="flex gap-3">
          ...
          >
            <Eye size={15} className="text-gray-400 group-hover:text-black dark:group-hover:text-white transition-colors duration-300" />
            View Link
          </a>
          <button className="flex-1 flex items-center justify-center gap-2 py-2 rounded-xl border border-gray-200 dark:border-[#2d2d33] bg-gray-50 dark:bg-[#16171a] hover:bg-gray-100 dark:hover:bg-[#202126] text-[13px] font-medium text-gray-700 dark:text-gray-200 transition-colors duration-300 group cursor-pointer">
            <Sparkles size={15} className="text-blue-600 dark:text-blue-500 group-hover:text-blue-500 dark:group-hover:text-blue-400 transition-colors duration-300" />
            Ask Ai
          </button>
        </div>
      </div>
